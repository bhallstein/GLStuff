...
inline void dataToImage_grayscale_unsigned_char(unsigned char *data, int width, int height, const char *fn) {
...
inline void dataToImage_grayscale_float_0to1(float *data, int width, int height, const char *filename) {
